...
function buildMovieTable() {
    // Build a table row  
    var row= "<tr><td><a href=" + BoxOfficeDraft[idVal].BOM_link + " target='_blank'>" + BoxOfficeDraft[idVal].Movie + "</a></td><td>" + BoxOfficeDraft[idVal].Owner + "</td><td> $" + (BoxOfficeDraft[idVal].DomesticGross/1000000).toFixed(2) + " Mil</td></tr>"
